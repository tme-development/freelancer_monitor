        ...
        <div class="text-right">
          ...
          <template v-if="!isTrashed">
            ...
            <button
              ...
              class="mt-2 ml-2 text-xs bg-blue-100 hover:bg-blue-200 text-blue-700 px-2 py-1 rounded disabled:opacity-50 dark:bg-blue-500/20 dark:hover:bg-blue-500/30 dark:text-blue-200"
            >
              {{
                creatingApplication
                  ? 'Generating...'
