...
MCP tool (`extract_requirementsmi`, `match_requirements`, `classify_poster`,
...
- Backend REST: [http://localhost:4000/api](http://localhost:4000/api)
- Ollama-MCP health: [http://localhost:3100/health](http://localhost:3100/health)
- Playwright-MCP health: [http://localhost:3200/health](http://localhost:3200/health)
